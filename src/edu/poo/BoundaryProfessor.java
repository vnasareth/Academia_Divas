...
public class BoundaryProfessor extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		gridPane.add(labelSalario, 0, 4);
		gridPane.add(txtSalario, 1, 4);
		gridPane.add(labelDataNascimento, 0,5 );
		gridPane.add(txtDataNascimento, 1, 5);
		gridPane.add(labelTelefone, 0, 6);
		gridPane.add(txtTelefone, 1, 6);
		
		gridPane.add(botaoAdicionar, 0, 7);
		gridPane.add(botaoPesquisar, 1, 7);
		...
		Bindings.bindBidirectional(txtSalario.textProperty(), control.SalarioProperty());
